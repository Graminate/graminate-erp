...
const SettingsBar = () => {
    ...
    if (!isLoadingUserDetails) {
      if (userType === "Producer") {
        yourPreferenceSubItems.push({
          ...
          href: `/platform/${userId}/settings/weather_settings`, // Updated href
        });
        if (subTypes.includes("Poultry")) {
          yourPreferenceSubItems.push({
            label: t("poultry" as GeneralTranslationKeys),
            href: `/platform/${userId}/settings/poultry_settings`, // Updated href
          });
        }
        if (subTypes.includes("Fishery")) {
          yourPreferenceSubItems.push({
            label: t("fishery" as GeneralTranslationKeys),
            href: `/platform/${userId}/settings/fishery_settings`, // Updated href
          });
        }
        if (subTypes.includes("Animal Husbandry")) {
          yourPreferenceSubItems.push({
            label: t("animalHusbandry" as GeneralTranslationKeys),
            href: `/platform/${userId}/settings/animal_husbandry_settings`, // Updated href
          });
        }
      }
    }
  ...
  const currentPath = router.pathname; // Use pathname for active link matching
